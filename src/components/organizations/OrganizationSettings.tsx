...
export function OrganizationSettings({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 overflow-y-auto p-2 xs:p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg p-3 xs:p-4 sm:p-6 max-w-4xl w-full mx-2 xs:mx-4 my-2 xs:my-4 sm:my-8 max-h-[95vh] xs:max-h-[90vh] overflow-y-auto">
